...
import com.avinash.aidlsdk.SensorService
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sensorDataText = findViewById(R.id.tvSensorData)
        connectionButton = findViewById(R.id.btServiceConnection)
        setObservers()
